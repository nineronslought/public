...
<main id="content">
    <section class="page-hdr">
        ...
        <figure>
            <img src="<?php echo get_theme_file_uri() ?>/img/default-hdr.webp" alt="Three woman staring at the sun" />
        </figure>
        <div class="content">
        <?php
            if (is_category() || is_tag()) {
                ...
                // Check if it's any taxonomy archive, including custom taxonomies
                $term = get_queried_object();
                echo '<h1>' . esc_html($term->name) . '</h1>';  // Display the term name
